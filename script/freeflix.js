...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const rereder = () => {
    ...
    const newData = videoData.filter((i) =>
      i.title.toLocaleLowerCase().includes(dataToBeSeached.toLocaleLowerCase())
    );
    newData.map((video) => {
      const videoDiv = document.createElement("div");
      videoDiv.className = "video-preview";
  ...
  document
    .getElementById("searchContentButton")
